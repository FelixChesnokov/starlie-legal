...
- **"Personal Information"** means information that allows someone to identify or contact you, including, for example, your name and email address.
...
Capitalized terms used in this Privacy Policy but not defined here have the meanings given to them in the Starlie Terms of Use (the **"Terms of Use"**).

## Use of Our Services

By registering with us or using our Products, you acknowledge that you have read and understand this Privacy Policy. We process personal information for the purposes described in this Privacy Policy and only as permitted by applicable law.

## Data Controller

The controller responsible for your personal information is Individual Entrepreneur (FOP) Feliks Chesnokov, located at Topol 1, 11.37, Dnipro, 49000, Ukraine. You can contact us about this Privacy Policy or about your personal information by email at support.starlie@gmail.com.

## Parent or Guardian as the Person Responsible for the Child's Data

The Products are designed for use by a parent or legal guardian to track and support the care of their child. When you provide information about your child, you do so as a parent or guardian who controls and is responsible for that information.
...
We rely on you, the parent or guardian, to decide what information about your child you share with us and to keep that information accurate. You can review, change, or delete the child's information at any time through the Products or by contacting us at support.starlie@gmail.com.

## Legal Bases for Processing

We only process your and your child's personal information where we have a lawful basis to do so. Under the EU General Data Protection Regulation (GDPR), Article 6, the bases we rely on are:

- **Performance of a contract (Art. 6(1)(b)):** to create and manage your Account, to provide the Products and their core tracking features, to process your purchases, and to provide customer support.
- **Consent (Art. 6(1)(a)):** to process delicate (health-adjacent) information about your child as described below, to process photos and attachments you choose to add, to use the Starlie AI assistant features that process such information, and to send you promotional messages. You can withdraw your consent at any time, without affecting the lawfulness of processing carried out before withdrawal.
- **Legitimate interests (Art. 6(1)(f)):** to secure your Account and our Products, to prevent fraud and abuse, to understand and improve how the Products are used, and to create and use Anonymous Information. Where we rely on legitimate interests, we balance them against your rights and interests.
- **Compliance with a legal obligation (Art. 6(1)(c)):** to meet our legal, tax, and regulatory obligations, and to respond to lawful requests from authorities.

For users in Ukraine, we process personal data on one of the grounds set out in Article 11 of the Law of Ukraine "On Personal Data Protection" (No. 2297-VI), which provides an equivalent set of grounds, including the data subject's consent, the performance of a contract to which the data subject is a party, and the legitimate interests of the controller.

## Explicit Consent for Delicate (Health-Adjacent) Child Data
...
- a finding that the destination country provides an adequate level of protection (for transfers within the EU/EEA, or to a country recognized as providing adequate protection);
- where required for transfers from the EU/EEA to a country without an adequacy decision, an appropriate safeguard, such as the European Commission's Standard Contractual Clauses; and
- for transfers governed by the Law of Ukraine No. 2297-VI, the protection mechanisms permitted under Article 29 of that Law, which include transfers to states ensuring an adequate level of protection (the EU/EEA member states are treated as ensuring such protection) and transfers based on the unambiguous consent of the data subject.

We take steps designed to ensure that your information is handled in accordance with this Privacy Policy and with applicable legal requirements, including implementing appropriate safeguards where required.

## Information That We Collect About You or Your Child

As we are an application and service that helps improve the wellness of young children (including, but not limited to, behavior, feeding, bathroom, activities, temperament, personality, and the length and quality of their sleep), we must collect some information about them. We will also collect some information about you, the child's parent or guardian, since you will be the user of the Products.

### Information About You That We Collect From You

- When you register for one of our Products, we ask you for and collect your name, email address, and password for your Account.
- Information that we may ask for about your child, used strictly and confidentially to provide the activity-tracking and childcare services, includes:
  - Your child's name.
  - Your child's age and birthdate.
  - Your child's gender.
  - The time zone where your child resides.
  - Your child's daily activities, including but not limited to:
    - Your child's sleep patterns and how he or she falls asleep or wakes up.
    - How your child is cared for during the day.
    ...
    - Your child's feeding (including breast, bottle, pumping, and solids/first foods, including allergens introduced and any reactions), diapers, growth measurements, walks, and other activities.
    - Temperament.
    - Bathroom habits.
...
- When you use our Products, we record certain information automatically, for example your Internet protocol (**"IP"**) address, device type, operating system, screen size and resolution, the time and date at which you access our Products, and an estimate of your geographic location.
...
Subject to applicable law, you have the following rights in relation to your personal information, and (acting as the responsible parent or guardian) in relation to your child's personal information:

- **Access:** to obtain confirmation of whether we process the information and to receive a copy of it;
- **Rectification:** to have inaccurate or incomplete information corrected;
- **Erasure:** to request deletion of the information in certain circumstances;
...
- **Restriction:** to request that we limit our processing of the information in certain circumstances;
...
To exercise any of these rights, please contact us at support.starlie@gmail.com. We will respond within the time limits required by applicable law. We may need to verify your identity before acting on a request.
...
If you are in the United Kingdom, we process your and your child's personal information in accordance with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018. You have the same rights as those described in the section "Your Data Protection Rights," which you can exercise by contacting us at support.starlie@gmail.com. You also have the right to lodge a complaint with the Information Commissioner's Office (ICO); see ico.org.uk. For transfers of personal information out of the United Kingdom, we rely on the UK International Data Transfer Agreement (IDTA) or the UK Addendum to the European Commission's Standard Contractual Clauses, or another lawful transfer mechanism.
...
> YOU ACKNOWLEDGE THAT SECURITY SAFEGUARDS, BY THEIR NATURE, ARE CAPABLE OF CIRCUMVENTION AND STARLIE DOES NOT AND CANNOT GUARANTEE THAT YOUR PERSONAL INFORMATION WILL NOT BE ACCESSED BY UNAUTHORIZED PERSONS CAPABLE OF OVERCOMING SUCH SAFEGUARDS. IN PARTICULAR, OUR PRODUCTS MAY BE USED TO ACCESS AND TRANSFER INFORMATION, INCLUDING YOUR PERSONAL INFORMATION, OVER THE INTERNET. YOU ACKNOWLEDGE AND AGREE THAT STARLIE DOES NOT OPERATE OR CONTROL THE INTERNET AND THAT UNAUTHORIZED USERS (SUCH AS HACKERS) MAY USE VIRUSES, WORMS, TROJAN HORSES, AND OTHER UNDESIRABLE DATA AND SOFTWARE TO OBTAIN ACCESS TO OR DAMAGE OUR PRODUCTS, OR YOUR PERSONAL INFORMATION.
